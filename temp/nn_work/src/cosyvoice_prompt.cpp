...
cosyvoice_prompt_t cosyvoice_prompt_init_from_prompt_speech(cosyvoice_context_t ctx, cosyvoice_prompt_speech_t prompt_speech)
{
	...
	prompt->orig_prompt_text = std::make_pair(std::shared_ptr<int>(new int[tokenized_text.tokens.size()], std::default_delete<int[]>()), tokenized_text.get_n_tokens());
